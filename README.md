...
#### remarks / future work:
- in case 2 reads from the same pair disagree on a site, it's treated as a missing site ('.').
- We skip the first/last 3 characters in every read, because of the methylation bias
